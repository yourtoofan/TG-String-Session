...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Support Group', url='https://t.me/nothing_bots_support'),
                InlineKeyboardButton('Developer', url='https://t.me/its_damiann')
            ],
            [
                InlineKeyboardButton('Bots Updates Channel', url='https://t.me/about_tosuu'),
            ]
        ]
    )
